...
LinkBoost::LinkBoost(int i, std::unordered_map<char, Link*> &charToLink_, Board &board_)
    : Ability("LinkBoost", "char",
              "Allows one of your links to move two spaces at a time, being "
              "able to jump "
              "over obstacles.",
              "ability " + std::to_string(i) + " <personalLinkChar>", i, charToLink_, board_) {}
...
Firewall::Firewall(int i, std::unordered_map<char, Link*> &charToLink_, Board &board_)
    : Ability("Firewall", "intint",
              ...
              "ability " + std::to_string(i) + " <rowNum> <colNum>", i, charToLink_, board_){};
...
Download::Download(int i, std::unordered_map<char, Link*> &charToLink_, Board &board_)
    : Ability("Download", "char", "Downloads an opponent's link.",
              "ability " + std::to_string(i) + " <opponentLinkChar>", i, charToLink_, board_){};
...
Polarize::Polarize(int i, std::unordered_map<char, Link*> &charToLink_, Board &board_)
    : Ability("Polarize", "char",
              "Changes any link from a data to a virus of same strength, or "
              "vice versa.",
              "ability " + std::to_string(i) + " <linkChar>", i, charToLink_, board_){};
...
LinkReborn::LinkReborn(int i, std::unordered_map<char, Link*> &charToLink_, Board &board_)
    : Ability(
          "LinkReborn", "char",
...
HighGround::HighGround(int i, std::unordered_map<char, Link*> &charToLink_, Board &board_)
...
Portal::Portal(int i, std::unordered_map<char, Link*> &charToLink_, Board &board_)
